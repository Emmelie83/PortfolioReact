...
const Header: React.FC = () => (
	<div id="start">
		<NavBar />
		<header className="flex flex-col lg:flex-row items-center justify-center max-w-screen-xl mx-auto lg:h-[600px] gap-10 px-4 md:px-14 lg:px-16 pt-20 lg:pt-10 lg:mt-10 md:pt-30 mb-10 sm:mb-20 lg:mb-0">
			<img
