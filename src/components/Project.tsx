...
const Project: React.FC<ProjectProps> = ({
	...
	<div
		className={`flex flex-col lg:flex-row lg:gap-5 xl:gap-10 md:w-3/4 lg:w-full bg-[#1A1A26] my-10 p-2 sm:p-6 md:p-8 lg:px-4 lg:py-8 xl:p-10 rounded-xl justify-center ${
