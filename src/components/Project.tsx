...
const Project: React.FC<ProjectProps> = ({
	...
	<div
		className={`flex flex-col lg:flex-row lg:gap-10 mb-20 md:w-9/10 lg:w-full ${
		...
		<div className="order-1 md:order-2 lg:w-1/2 flex flex-col justify-center">
			...
			<div className="mt-2 lg:mt-3 mb-1 lg:mb-2 lg:w-full lg:max-w-[800px] xl:w-4/5">{description}</div>
