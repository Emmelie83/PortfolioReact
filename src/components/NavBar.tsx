...
export default function NavBar() {
	...
	return (
		<header id="start" className="flex justify-center">
			<nav className="fixed text-md font-light top-0 w-full z-20 bg-[#10101A] uppercase">
				{/* Desktop */}
				...
				{/* Mobile Menu */}
				{menuOpen && (
					<div className="flex flex-col gap-4 px-10 pb-10 lg:hidden bg-[#10101A] text-left items-start w-full h-lvh transition-all duration-300 ease-in-out">
